...
class SDUIAction {
  ...
  Future<String?> _executeCommand(
    ...
    var response = await Http.getInstance().post(_urlWithParameters(), data);
    _logger.i('I gonna do this $response');
    return SDUIAction().fromJson(response).execute(context, null);
  }
